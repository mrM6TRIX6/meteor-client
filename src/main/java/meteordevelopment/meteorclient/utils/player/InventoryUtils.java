...
public class InventoryUtils {
    ...
    /**
     * When writing code with quickSwap, both to and from should provide the ID of a slot, not the index. From should be
     * the slot in the hotbar, to should be the slot you're switching an item from.
     */
