...
public class PlayerUtils {
    ...
    public static Color getPlayerColor(PlayerEntity entity, Color defaultColor) {
        ...
        if (Config.get().useTeamColor.get() && !color.set(TextUtils.getMostPopularColor(entity.getDisplayName())).equals(new Color())) {
    ...
    public static void centerPlayer(boolean middle) {
        double x;
        double z;
    ...
    public static void warp(double x1, double y1, double z1, double x2, double y2, double z2) {
        ...
        double distance = Utils.distance(x1, y1, z1, x2, y2, z2);
        ...
        mc.player.networkHandler.sendPacket(new PlayerMoveC2SPacket.PositionAndOnGround(x2, y2, z2, true, false));
    }
    ...
    public static boolean shouldPause(boolean ifBreaking, boolean ifEating, boolean ifDrinking) {
        ...
        if (ifEating && (mc.player.isUsingItem() && (mc.player.getMainHandStack().getItem().getComponents().contains(DataComponentTypes.FOOD) || mc.player.getOffHandStack().getItem().getComponents().contains(DataComponentTypes.FOOD)))) {
            return true;
        }
