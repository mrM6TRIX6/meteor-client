...
public class DamageUtils {
    ...
    /**
     * It is recommended to use this {@link RaycastFactory} unless you implement custom behaviour, as soon:tm: it will
     * be the target of optimizations to make it more performant.
     *
        ...
        if (attacker instanceof PlayerEntity playerEntity) {
            ...
            if (weapon.getItem() instanceof MaceItem item) {
                ...
                if (bonusDamage > 0f) {
                    ...
                    if (density > 0) {
                        bonusDamage += (float) (0.5f * attacker.fallDistance);
                    }
                    damage += bonusDamage;
                }
            }
