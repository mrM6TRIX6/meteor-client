...
public class PeekScreen extends ShulkerBoxScreen {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        context.drawTexture(RenderPipelines.GUI_TEXTURED, TEXTURE, i, j, 0f, 0f,
            backgroundWidth, backgroundHeight, backgroundWidth, backgroundHeight, 256, 256,
            ColorHelper.fromFloats(color.r / 255f, color.g / 255f, color.b / 255f, color.a / 255f));
    }
