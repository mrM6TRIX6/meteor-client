 ...
 * {@link HttpClient#send(HttpRequest, BodyHandler)} throws an exception instead of returning an error response, such as
 * when the connection is interrupted or an I/O error occurs. This object is used to prevent {@code sendRequest} methods
 * from returning {@code null}.
 *
 * @author Crosby
 */
