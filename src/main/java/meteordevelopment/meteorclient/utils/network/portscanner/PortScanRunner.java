...
public class PortScanRunner {
    ...
    public PortScanRunner(InetAddress address, int threads, int threadDelay, int timeoutMS, Collection<Integer> ports, Consumer<List<PortScannerManager.ScanResult>> callback) {
        runner = new Thread(() -> {
