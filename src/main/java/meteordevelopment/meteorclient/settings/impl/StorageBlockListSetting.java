...
public class StorageBlockListSetting extends Setting<List<BlockEntityType<?>>> {
    ...
    public StorageBlockListSetting(String name, String title, String description, List<BlockEntityType<?>> defaultValue, Consumer<List<BlockEntityType<?>>> onChanged, Consumer<Setting<List<BlockEntityType<?>>>> onModuleActivated, IVisible visible) {
    ...
    public static class Builder extends SettingBuilder<Builder, List<BlockEntityType<?>>, StorageBlockListSetting> {
        ...
        public StorageBlockListSetting build() {
            return new StorageBlockListSetting(name, title, description, defaultValue, onChanged, onModuleActivated, visible);
        }
