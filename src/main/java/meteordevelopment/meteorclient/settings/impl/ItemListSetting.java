...
public class ItemListSetting extends Setting<List<Item>> {
    ...
    public ItemListSetting(String name, String title, String description, List<Item> defaultValue, Consumer<List<Item>> onChanged, Consumer<Setting<List<Item>>> onModuleActivated, IVisible visible, Predicate<Item> filter, boolean bypassFilterWhenSavingAndLoading) {
    ...
    public static class Builder extends SettingBuilder<Builder, List<Item>, ItemListSetting> {
        ...
        public ItemListSetting build() {
            return new ItemListSetting(name, title, description, defaultValue, onChanged, onModuleActivated, visible, filter, bypassFilterWhenSavingAndLoading);
        }
