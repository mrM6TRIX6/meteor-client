...
public class RangeSetting extends Setting<Range> {
    ...
    public RangeSetting(String name, String description, Range defaultValue, Consumer<Range> onChanged, Consumer<Setting<Range>> onModuleActivated, IVisible visible, int min, int max, int sliderMin, int sliderMax, boolean noSlider) {
