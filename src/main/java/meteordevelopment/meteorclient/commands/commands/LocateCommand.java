...
public class LocateCommand extends Command {
    ...
    public void build(LiteralArgumentBuilder<CommandSource> builder) {
        ...
        builder.then(literal("stronghold")
            .executes(s -> {
                boolean foundEye = InventoryUtils.testInHotbar(Items.ENDER_EYE);
        ...
        builder.then(literal("nether_fortress")
            .executes(s -> {
        ...
        builder.then(literal("lodestone")
            .executes(s -> {
                ItemStack stack = mc.player.getInventory().getSelectedStack();
