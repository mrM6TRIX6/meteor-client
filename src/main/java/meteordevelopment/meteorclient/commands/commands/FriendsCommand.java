...
public class FriendsCommand extends Command {
    ...
    public void build(LiteralArgumentBuilder<CommandSource> builder) {
            ...
            .then(argument("player", PlayerListEntryArgumentType.create())
                .executes(context -> {
                    ...
                    if (Friends.get().add(friend)) {
                        ...
                        error("Already friends with that player.");
                    }
            ...
            .then(argument("friend", FriendArgumentType.create())
                .executes(context -> {
                    ...
                    if (Friends.get().remove(friend)) {
                        ...
                        error("Failed to remove that friend.");
                    }
        ...
        builder.then(literal("clear")
            .executes(context -> {
                Friends.get().clear();
                ChatUtils.info("Friends has been cleared.");
        ...
        builder.then(literal("list")
            .executes(context -> {
                ChatUtils.info("--- Friends ((highlight)%s(default)) ---", Friends.get().getCount());
