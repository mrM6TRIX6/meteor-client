...
public class GuiRenderer {
    ...
    private final Renderer2D render = new Renderer2D(false);
    private final Renderer2D renderTexture = new Renderer2D(true);
    ...
    public void quad(double x, double y, double width, double height, QuadColorState color) {
        render.quad(x, y, width, height, color);
    }
    ...
    public void quad(WWidget widget, QuadColorState color) {
    ...
    public void quad(double x, double y, double width, double height, GuiTexture texture, Color color) {
        renderTexture.texQuad(x, y, width, height, texture.get(width, height), color);
    }
    
    public void rotatedQuad(double x, double y, double width, double height, double rotation, GuiTexture texture, Color color) {
        renderTexture.texQuad(x, y, width, height, rotation, texture.get(width, height), color);
    }
