...
public abstract class GuiTheme implements ISerializable<GuiTheme> {
    ...
    public abstract WRangeSlider rangeSlider(Range value, int min, int max);
    ...
    public WRangeEdit rangeEdit(Range value, int min, int max, int sliderMin, int sliderMax, boolean noSlider) {
        return w(new WRangeEdit(value, min, max, sliderMin, sliderMax, noSlider));
    }
    
    public WRangeEdit rangeEdit(Range value, int min, int max, int sliderMin, int sliderMax) {
        return w(new WRangeEdit(value, min, max, sliderMin, sliderMax, false));
    }
    
    public WRangeEdit rangeEdit(Range value, int min, int max, boolean noSlider) {
        return w(new WRangeEdit(value, min, max, 0, 0, noSlider));
    }
