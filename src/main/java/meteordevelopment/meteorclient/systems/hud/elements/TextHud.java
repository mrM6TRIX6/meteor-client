...
public class TextHud extends HudElement {
    ...
    private void calculateSize(HudRenderer renderer) {
        ...
        if (section != null) {
            ...
            if (!str.isBlank()) {
                width = renderer.textWidth(str, shadow.get(), getScale());
            }
        }
    ...
    private void runTick(HudRenderer renderer) {
        if (needsCompile) {
            ...
            if (result.hasErrors()) {
                ...
                script = Compiler.compile(result);
            }
        ...
        if (shown.get() != Shown.ALWAYS && conditionScript != null) {
            ...
            if (text == null) {
                ...
                visible = shown.get() == Shown.WHEN_TRUE ? text.equalsIgnoreCase("true") : text.equalsIgnoreCase("false");
            }
        }
