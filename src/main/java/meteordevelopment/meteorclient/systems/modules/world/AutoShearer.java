...
public class AutoShearer extends Module {
    ...
    private void onTickPre(TickEvent.Pre event) {
        ...
        for (Entity entity : mc.world.getEntities()) {
            ...
            FindItemResult findShear = InventoryUtils.findInHotbar(itemStack -> itemStack.getItem() == Items.SHEARS && (!antiBreak.get() || itemStack.getDamage() < itemStack.getMaxDamage() - 1));
            if (!InventoryUtils.swap(findShear.slot(), true)) {
                return;
            }
