...
import meteordevelopment.meteorclient.systems.commands.impl.SayCommand;
import meteordevelopment.meteorclient.systems.modules.Category;
import meteordevelopment.meteorclient.systems.modules.Module;
import meteordevelopment.meteorclient.utils.Utils;
import meteordevelopment.meteorclient.utils.player.ChatUtils;
import meteordevelopment.meteorclient.utils.text.MeteorClickEvent;
import meteordevelopment.meteorclient.utils.text.TextVisitor;
...
public class BetterChat extends Module {
    ...
    private final Setting<Boolean> copyingMessages = sgGeneral.add(new BoolSetting.Builder()
        .name("CopyingMessages")
    ...
    @EventHandler
    private void onMessageSend(MessageEvent.Send event) {
    ...
    private MutableText getSendButton(String message) {
        ...
        sendButton.setStyle(sendButton.getStyle()
            ...
            .withClickEvent(new MeteorClickEvent(Commands.get().get(SayCommand.class).toString(message)))
