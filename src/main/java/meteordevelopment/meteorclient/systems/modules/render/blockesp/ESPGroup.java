        ...
        if (!neighbours.isEmpty()) {
            ...
            if (neighbours.size() > 1) {
                ...
                for (ESPBlock b : neighbours) {
                    int x = b.x - block.x;
                    if (x == 1) {
                        block.neighbours |= ESPBlock.RI;
                    } else if (x == -1) {
                        block.neighbours |= ESPBlock.LE;
                    }
                    
                    int y = b.y - block.y;
                    if (y == 1) {
                        block.neighbours |= ESPBlock.TO;
                    } else if (y == -1) {
                        block.neighbours |= ESPBlock.BO;
                    }
                    
                    int z = b.z - block.z;
                    if (z == 1) {
                        block.neighbours |= ESPBlock.FO;
                    } else if (z == -1) {
                        block.neighbours |= ESPBlock.BA;
                    }
                }
