...
public class HUDRenderer {
    ...
    private void onCustomFontChanged(CustomFontChangedEvent event) {
        ...
        for (FontHolder fontHolder : fontsInUse.values()) {
            fontHolder.destroy();
        }
        for (FontHolder fontHolder : fontCache.asMap().values()) {
            fontHolder.destroy();
        }
    ...
    private static class FontHolder {
        ...
        public MeshBuilder getMesh() {
            if (mesh == null) {
                mesh = new MeshBuilder(MeteorRenderPipelines.UI_TEXT);
            }
            if (!mesh.isBuilding()) {
                mesh.begin();
            }
