...
import meteordevelopment.meteorclient.settings.impl.ModuleListSetting;
...
public class ModuleInfosHUD extends HUDElement {
    ...
    public static final HUDElementInfo<ModuleInfosHUD> INFO = new HUDElementInfo<>(HUD.GROUP, "ModuleInfos", "Displays if selected modules are enabled or disabled.", ModuleInfosHUD::new);
    ...
    private final Setting<List<Module>> modules = sgGeneral.add(new ModuleListSetting.Builder()
        ...
        .defaultValue(KillAura.class, CrystalAura.class, AnchorAura.class, BedAura.class)
        .build()
    );
    ...
    public void render(HUDRenderer renderer) {
        ...
        for (Module module : modules.get()) {
            double moduleWidth = renderer.textWidth(module.name) + renderer.textWidth(" ");
            String text = null;
            ...
            x = renderer.text(module.name, x, y, moduleColor.get(), textShadow.get());
