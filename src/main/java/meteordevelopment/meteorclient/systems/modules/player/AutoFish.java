...
public class AutoFish extends Module {
    ...
    private boolean hasFishingRod() {
        return InventoryUtils.swap(InventoryUtils.findInHotbar(itemStack -> itemStack.getItem() == Items.FISHING_ROD && (!antiBreak.get() || itemStack.getDamage() < itemStack.getMaxDamage() - 1)).slot(), false);
    }
