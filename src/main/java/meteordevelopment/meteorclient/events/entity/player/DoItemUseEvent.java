 ...
 * (e.g. InteractItemEvent) are called twice because the method loops over the Mainhand and the Offhand. This event is only
 * called once, before any interaction logic is called.
 */
