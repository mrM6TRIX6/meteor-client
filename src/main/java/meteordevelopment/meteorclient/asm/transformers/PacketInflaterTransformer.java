...
/**
 * Future compatibility Future uses @ModifyConstant which does not chain when multiple mods do it and mixins /
 * mixinextra can't target throw statements. So using a custom ASM transformer we wrap the throw statement inside
