...
base {
    ...
    val buildNumber = if (project.hasProperty("build_number")) {
...
dependencies {
    ...
    // Workaround for J2ObjC annotation warnings during compilation
    // Prevents "unknown enum constant Level.FULL" warnings from Google libraries
